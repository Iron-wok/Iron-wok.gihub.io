document.addEventListener("DOMContentLoaded", function() { // HTMLがよみこまれてから動く
    ...
    const BuffImg = document.querySelector(".buffimg");
    const ticketsPack = document.querySelector(".ticketpackbox");
    const ticketinPack = document.querySelectorAll(".ticketinpack");
        ...
        button.addEventListener("click", function() {
            if (index == 0) {
                if (coin >= 3) {
                    ...
                    BuffImg.src = buffImages[buffcolor];
                    openpack(index);
                    dicerollinpack();
                } else return;
            }
            if (index == 1) {
                if (coin >= 3) {
                    ...
                    BuffImg.src = diceImages[0][buffnumber];
                    openpack(index);
                    dicerollinpack();
                } else return;
            }
            if (index == 2) {
                if (coin >= 5) {
                    coin -= 5;
                    BuffImg.src = diceImages[sidecolor][sidenum];
                    openpack(index);
                    dicerollinpack();
                } else return;
            }
    ...
    ticketinPack.forEach((ticket, index) => {
...
//========================================================================================================
    ...
    function ticketroll(n) {
        ...
        for (i = 0; i < n; i++) {
            ticketinPack[i].src = ticketImages[numbers[i]];
            ticketinPack[i].style.display = "";
        }
        if (n == 3) {
            ticketinPack[3].style.display = "none";
            ticketinPack[4].style.display = "none";
        }
        resetchoicedTicket();
        decideBuffButton.disabled = true;
        decideBuffButton.style.opacity = "0.7";
